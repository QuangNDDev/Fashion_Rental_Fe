...
const CancelBuyStaff = () => {
  ...
  const showDrawer = async (record) => {
    ...
    try {
      ...
      console.log(responseOrderbuy.data);
    } catch (error) {
      console.error(error);
    }
  };
          ...
          <div style={{ display: "flex" }}>
            ...
            <div style={{ width: "50%" }}>
              ...
              <Form.Item
                name="dateOrder"
                initialValue={
                  selectedOrderBuy && selectedOrderBuy.dateOrder
                }
              >
                <div style={{ display: "flex" }}>
              ...
              <Form.Item
                name="shippingFee"
                initialValue={
                  selectedOrderBuy && selectedOrderBuy.shippingFee
                }
              >
                <div style={{ display: "flex" }}>
              ...
              <Form.Item
                name="total"
                initialValue={
                  selectedOrderBuy && selectedOrderBuy.total
                }
              >
                <div style={{ display: "flex" }}>
